...
2. **Exportar lista** de documentos a CSV x6
3. **Búsqueda/filtrado** en historial X 2
4. **Dark mode** toggle X 1
5. **Animaciones** de transición
6. **Pruebas en testnet** (Sepolia) x 3
7. **IPFS** para almacenar archivo completo x 5
8. **ENS** para nombres legibles x 4
